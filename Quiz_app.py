...
def loginPage(logdata):
    ...
    login_canvas = Canvas(login,width=720,height=440,bg="red")
    login_canvas.pack()
...
def menu(a):
    ...
    menu_frame = Frame(menu_canvas,bg="orange")
...
def easy():
    ...
    easy_frame = Frame(easy_canvas,bg="orange")
    ...
    def display():
        ...
        if li:
            ...
            a.configure(text=easyQ[x][1],value=easyQ[x][1],command=calc)

            b.configure(text=easyQ[x][2],value=easyQ[x][2],command=calc)

            c.configure(text=easyQ[x][3],value=easyQ[x][3],command=calc)

            d.configure(text=easyQ[x][4],value=easyQ[x][4],command=calc)
    ...
    submit = Button(easy_frame,command=display,text="Submit", fg="white", bg="black")
...
def medium():
    ...
    med_canvas = Canvas(m,width=720,height=440,bg="red")
    med_canvas.pack()

    med_frame = Frame(med_canvas,bg="orange")
    ...
    a = Radiobutton(med_frame, text=mediumQ[x][1], font="calibri 10", value=mediumQ[x][1], variable=var, bg="#BADA55")
    a.place(relx=0.5, rely=0.42, anchor=CENTER)

    b = Radiobutton(med_frame, text=mediumQ[x][2], font="calibri 10", value=mediumQ[x][2], variable=var, bg="#BADA55")
    b.place(relx=0.5, rely=0.52, anchor=CENTER)

    c = Radiobutton(med_frame, text=mediumQ[x][3], font="calibri 10", value=mediumQ[x][3], variable=var, bg="#BADA55")
    c.place(relx=0.5, rely=0.62, anchor=CENTER)

    d = Radiobutton(med_frame, text=mediumQ[x][4], font="calibri 10", value=mediumQ[x][4], variable=var, bg="#BADA55")
    d.place(relx=0.5, rely=0.72, anchor=CENTER)
    ...
    def display():
        ...
        if li:
            ...
            a.configure(text=mediumQ[x][1], value=mediumQ[x][1], command=calc)

            b.configure(text=mediumQ[x][2], value=mediumQ[x][2], command=calc)

            c.configure(text=mediumQ[x][3], value=mediumQ[x][3], command=calc)

            d.configure(text=mediumQ[x][4], value=mediumQ[x][4], command=calc)
    ...
    submit = Button(med_frame, command=display, text="Submit", fg="white", bg="black")
    submit.place(relx=0.5, rely=0.82, anchor=CENTER)
...
def difficult():
    ...
    hard_canvas = Canvas(h,width=720,height=440,bg="red")
    hard_canvas.pack()

    hard_frame = Frame(hard_canvas,bg="orange")
    ...
    def display():
        ...
        if li:
            ...
            a.configure(text=hardQ[x][1],value=hardQ[x][1],command=calc)

            b.configure(text=hardQ[x][2],value=hardQ[x][2],command=calc)

            c.configure(text=hardQ[x][3],value=hardQ[x][3],command=calc)

            d.configure(text=hardQ[x][4],value=hardQ[x][4],command=calc)
   ...
   # def lastPage():
    ...
    submit = Button(hard_frame,command=display,text="Submit", fg="white", bg="black")
    submit.place(relx=0.5,rely=0.82,anchor=CENTER)
...
def start():
    ...
    canvas = Canvas(root,width = 720,height = 440, bg = 'orange')
    canvas.grid(column = 0 , row = 1)
    img = PhotoImage(file="damozy.png")
